...
final class MTMathListTests: XCTestCase {
    ...
    func checkListContents(_ finalized: MTMathList) throws {
        ...
        XCTAssertTrue(NSEqualRanges(atom.indexRange, NSRange(location: 0, length: 1)), "Range")
        atom = finalized.atoms[1]
        XCTAssertEqual(atom.type, .number, "Atom 1")
        XCTAssertEqual(atom.nucleus, "52", "Atom 1 value")
        XCTAssertTrue(NSEqualRanges(atom.indexRange, NSRange(location: 1, length: 2)), "Range")
        atom = finalized.atoms[2]
        XCTAssertEqual(atom.type, .variable, "Atom 2")
        XCTAssertEqual(atom.nucleus, "x", "Atom 2 value")
        XCTAssertTrue(NSEqualRanges(atom.indexRange, NSRange(location: 3, length: 1)), "Range")
        ...
        XCTAssertTrue(NSEqualRanges(atom.indexRange, NSRange(location: 0, length: 2)), "Range")
        atom = superScr.atoms[1]
        XCTAssertEqual(atom.type, .binaryOperator, "Super Atom 1")
        XCTAssertEqual(atom.nucleus, "+", "Super Atom 1 value")
        XCTAssertTrue(NSEqualRanges(atom.indexRange, NSRange(location: 2, length: 1)), "Range")
        ...
        XCTAssertTrue(NSEqualRanges(atom.indexRange, NSRange(location: 0, length: 4)), "Range")
