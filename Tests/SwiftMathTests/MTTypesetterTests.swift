...
final class MTTypesetterTests: XCTestCase {
    ...
    func testSimpleVariable() throws {
        ...
        XCTAssertTrue(CGPointEqualToPoint(display.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(display.range, NSRange(location: 0, length: 1)))
        ...
        XCTAssertTrue(CGPointEqualToPoint(line.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(line.range, NSRange(location: 0, length: 1)))
    ...
    func testMultipleVariables() throws {
        ...
        XCTAssertEqual(display.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(display.range, NSRange(location: 0, length: 4)), "Got \(display.range) instead")
        XCTAssertFalse(display.hasScript)
        XCTAssertEqual(display.index, NSNotFound)
        XCTAssertEqual(display.subDisplays.count, 1)
        ...
        XCTAssertTrue(CGPointEqualToPoint(line.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(line.range, NSRange(location: 0, length: 4)))
        XCTAssertFalse(line.hasScript)
    ...
    func testEquationWithOperatorsAndRelations() throws {
        ...
        XCTAssertEqual(display.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(display.range, NSRange(location: 0, length: 6)), "Got \(display.range) instead")
        XCTAssertFalse(display.hasScript)
        XCTAssertEqual(display.index, NSNotFound)
        XCTAssertEqual(display.subDisplays.count, 1)
        ...
        XCTAssertTrue(CGPointEqualToPoint(line.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(line.range, NSRange(location: 0, length: 6)))
        XCTAssertFalse(line.hasScript)
...
//        XCTAssertEqual(r1.length, r2.length, __VA_ARGS__)
    ...
    func testSuperscript() throws {
        ...
        XCTAssertTrue(CGPointEqualToPoint(display2.position, CGPoint(x: 11.44, y: 7.26)))
        XCTAssertTrue(NSEqualRanges(display2.range, NSRange(location: 0, length: 1)))
        ...
        XCTAssertTrue(CGPointEqualToPoint(line2.position, CGPoint.zero))
    ...
    func testSubscript() throws {
        ...
        XCTAssertTrue(CGPointEqualToPoint(display2.position, CGPoint(x: 11.44, y: -4.94)))
        XCTAssertTrue(NSEqualRanges(display2.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display2.hasScript)
        XCTAssertEqual(display2.index, 0)
        XCTAssertEqual(display2.subDisplays.count, 1)
    ...
    func testSupersubscript() throws {
        ...
        XCTAssertTrue(CGPointEqualToPoint(display3.position, CGPoint(x: 11.44, y: -5.264)))
        XCTAssertTrue(NSEqualRanges(display3.range, NSRange(location: 0, length: 1)))
        ...
        XCTAssertTrue(CGPointEqualToPoint(line3.position, CGPoint.zero))
    ...
    func testRadical() throws {
        ...
        XCTAssertTrue(NSEqualRanges(radical.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(radical.hasScript)
        XCTAssertTrue(CGPointEqualToPoint(radical.position, CGPoint.zero))
        ...
        XCTAssertTrue(CGPoint(x: 16.66, y: 0).isEqual(to: display2.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(display2.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display2.hasScript)
        ...
        XCTAssertEqual(line2.attributedString?.string, "1")
        XCTAssertTrue(CGPointEqualToPoint(line2.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(line2.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(line2.hasScript)
    ...
    func testRadicalWithDegree() throws {
        ...
        let display2 = radical.radicand!
        XCTAssertEqual(display2.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display2.position, CGPoint(x: 16.66, y: 0)))
        XCTAssertTrue(NSEqualRanges(display2.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display2.hasScript)
        XCTAssertEqual(display2.index, NSNotFound)
        XCTAssertEqual(display2.subDisplays.count, 1)
        ...
        XCTAssertTrue(CGPointEqualToPoint(display3.position, CGPoint(x: 6.12, y: 10.728)))
        XCTAssertTrue(NSEqualRanges(display3.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display3.hasScript)
        ...
        XCTAssertTrue(CGPointEqualToPoint(line3.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(line3.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(line3.hasScript)
    ...
    func testFraction() throws {
        ...
        XCTAssertTrue(NSEqualRanges(fraction.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(fraction.hasScript)
        XCTAssertTrue(CGPointEqualToPoint(fraction.position, CGPoint.zero))
        XCTAssertNotNil(fraction.numerator)
        XCTAssertNotNil(fraction.denominator)

        let display2 = fraction.numerator!
        XCTAssertEqual(display2.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display2.position, CGPoint(x: 0, y: 13.54)))
        XCTAssertTrue(NSEqualRanges(display2.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display2.hasScript)
        XCTAssertEqual(display2.index, NSNotFound)
        XCTAssertEqual(display2.subDisplays.count, 1)
        ...
        XCTAssertEqual(display3.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display3.position, CGPoint(x: 0, y: -13.72)))
        XCTAssertTrue(NSEqualRanges(display3.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display3.hasScript)
        XCTAssertEqual(display3.index, NSNotFound)
        XCTAssertEqual(display3.subDisplays.count, 1)
    ...
    func testBinomial() throws {
        ...
        XCTAssertTrue(CGPointEqualToPoint(display0.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(display0.range, NSRange(location: 0, length: 1)))
        ...
        let glyph = subLeft
        XCTAssertTrue(CGPointEqualToPoint(glyph.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(glyph.range, NSRange(location: NSNotFound, length: 0)))
        ...
        XCTAssertTrue(NSEqualRanges(fraction.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(fraction.hasScript)
        XCTAssertTrue(CGPointEqualToPoint(fraction.position, CGPoint(x: 14.72, y: 0)))
        XCTAssertNotNil(fraction.numerator)
        XCTAssertNotNil(fraction.denominator)

        let display2 = fraction.numerator!
        XCTAssertEqual(display2.type, .regular)
        XCTAssertTrue(CGPoint(x: 14.72, y: 13.54).isEqual(to: display2.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(display2.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display2.hasScript)
        XCTAssertEqual(display2.index, NSNotFound)
        XCTAssertEqual(display2.subDisplays.count, 1)
        ...
        let display3 = fraction.denominator!
        XCTAssertEqual(display3.type, .regular)
        XCTAssertTrue(CGPoint(x: 14.72, y: -13.72).isEqual(to: display3.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(display3.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display3.hasScript)
        XCTAssertEqual(display3.index, NSNotFound)
        XCTAssertEqual(display3.subDisplays.count, 1)
        ...
        XCTAssertTrue(CGPointEqualToPoint(glyph2.position, CGPoint(x: 24.72, y: 0)))
        XCTAssertTrue(NSEqualRanges(glyph2.range, NSRange(location: NSNotFound, length: 0)), "Got \(glyph2.range) instead")
    ...
    func testLargeOpNoLimitsText() throws {
        ...
        XCTAssertEqual(display.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(display.range, NSRange(location: 0, length: 2)), "Got \(display.range) instead")
        XCTAssertFalse(display.hasScript)
        XCTAssertEqual(display.index, NSNotFound)
        XCTAssertEqual(display.subDisplays.count, 2)
        ...
        XCTAssertTrue(CGPoint(x: 27.893, y: 0).isEqual(to: line2.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(line2.range, NSRange(location: 1, length: 1)), "Got \(line2.range) instead")
        XCTAssertFalse(line2.hasScript)
    ...
    func testLargeOpNoLimitsSymbol() throws {
        ...
        let glyph = sub0
        XCTAssertTrue(CGPointEqualToPoint(glyph.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(glyph.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(glyph.hasScript)
        ...
        XCTAssertEqual(line2.atoms.count, 1)
        XCTAssertEqual(line2.attributedString?.string, "𝑥")
        XCTAssertTrue(CGPoint(x: 23.313, y: 0).isEqual(to: line2.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(line2.range, NSRange(location: 1, length: 1)), "Got \(line2.range) instead")
        XCTAssertFalse(line2.hasScript)
    ...
    func testLargeOpNoLimitsSymbolWithScripts() throws {
        ...
        XCTAssertTrue(CGPointEqualToPoint(display0.position, CGPoint(x: 19.98, y: 23.72)))
        XCTAssertTrue(NSEqualRanges(display0.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display0.hasScript)
        ...
        XCTAssertTrue(CGPointEqualToPoint(line1.position, CGPoint.zero))
        ...
        XCTAssertTrue(CGPointEqualToPoint(display1.position, CGPoint(x: 8.16, y: -20.02)))
        XCTAssertTrue(NSEqualRanges(display1.range, NSRange(location: 0, length: 1)))
        ...
        XCTAssertEqual(line2.atoms.count, 1)
        XCTAssertEqual(line2.attributedString?.string, "𝑥")
        XCTAssertTrue(CGPoint(x: 31.433, y: 0).isEqual(to: line2.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(line2.range, NSRange(location: 1, length: 1)), "Got \(line2.range) instead")
        XCTAssertFalse(line1.hasScript)
    ...
    func testLargeOpWithLimitsTextWithScripts() throws {
        ...
        XCTAssertTrue(CGPointEqualToPoint(largeOp.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(largeOp.range, NSRange(location: 0, length: 1)))
        ...
        XCTAssertEqual(display2.type, .regular)
        XCTAssertTrue(CGPoint(x: 6.89, y: -12.00).isEqual(to: display2.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(display2.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display2.hasScript)
        XCTAssertEqual(display2.index, NSNotFound)
        XCTAssertEqual(display2.subDisplays.count, 1)
        ...
        XCTAssertEqual(line2.atoms.count, 1)
        XCTAssertEqual(line2.attributedString?.string, "𝑥")
        XCTAssertTrue(CGPoint(x: 31.1133, y: 0).isEqual(to: line2.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(line2.range, NSRange(location: 1, length: 1)), "Got \(line2.range) instead")
        XCTAssertFalse(line1.hasScript)
    ...
    func testLargeOpWithLimitsSymboltWithScripts() throws {
        ...
        let display2 = largeOp.lowerLimit!
        XCTAssertEqual(display2.type, .regular)
        XCTAssertTrue(CGPoint(x: 10.94, y: -21.664).isEqual(to: display2.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(display2.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display2.hasScript)
        XCTAssertEqual(display2.index, NSNotFound)
        XCTAssertEqual(display2.subDisplays.count, 1)
        ...
        XCTAssertTrue(CGPoint(x: 7.44, y: 23.154).isEqual(to: displayU.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(displayU.range, NSRange(location: 0, length: 1)))
        ...
        XCTAssertEqual(line2.atoms.count, 1)
        XCTAssertEqual(line2.attributedString?.string, "𝑥")
        XCTAssertTrue(CGPoint(x: 32.2133, y: 0).isEqual(to: line2.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(line2.range, NSRange(location: 1, length: 1)), "Got \(line2.range) instead")
        XCTAssertFalse(line2.hasScript)
    ...
    func testInner() throws {
        ...
        XCTAssertEqual(display2.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display2.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(display2.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display2.hasScript)
        XCTAssertEqual(display2.index, NSNotFound)
        ...
        XCTAssertEqual(display3.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display3.position, CGPoint(x: 7.78, y: 0)))
        XCTAssertTrue(NSEqualRanges(display3.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(display3.hasScript)
        XCTAssertEqual(display3.index, NSNotFound)
        XCTAssertEqual(display3.subDisplays.count, 1)
        ...
        XCTAssertTrue(subRight is MTGlyphDisplay)
        let glyph2 = subRight as! MTGlyphDisplay
        XCTAssertTrue(CGPointEqualToPoint(glyph2.position, CGPoint(x: 19.22, y: 0)))
        XCTAssertTrue(NSEqualRanges(glyph2.range, NSRange(location: NSNotFound, length: 0)), "Got \(glyph2.range) instead")
        XCTAssertFalse(glyph2.hasScript)
    ...
    func testOverline() throws {
        ...
        XCTAssertTrue(NSEqualRanges(overline.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(overline.hasScript)
        XCTAssertTrue(CGPointEqualToPoint(overline.position, CGPoint.zero))
    ...
    func testUnderline() throws {
        ...
        XCTAssertTrue(NSEqualRanges(underline.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(underline.hasScript)
        XCTAssertTrue(CGPointEqualToPoint(underline.position, CGPoint.zero))
    ...
    func testSpacing() throws {
        ...
        XCTAssertEqual(display.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(display.range, NSRange(location: 0, length: 3)), "Got \(display.range) instead")
        XCTAssertFalse(display.hasScript)
        XCTAssertEqual(display.index, NSNotFound)
        XCTAssertEqual(display.subDisplays.count, 2)
        ...
        XCTAssertTrue(CGPoint(x: 21.44, y: 0).isEqual(to: line2.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(line2.range, NSRange(location: 2, length: 1)), "Got \(line2.range) instead")
        XCTAssertFalse(line2.hasScript)
    ...
    func testMathTable() throws {
        ...
        for i in 0..<3 {
            ...
            XCTAssertTrue(CGPoint(x: 0, y: rowPos[i]).isEqual(to: row.position, accuracy: 0.01))
            XCTAssertTrue(NSEqualRanges(row.range, NSRange(location: 0, length: 3)))
            ...
            for j in 0..<3 {
                ...
                XCTAssertTrue(CGPoint(x: cellPos[i][j], y: 0).isEqual(to: col.position, accuracy: 0.01))
    ...
    func testStyleMiddle() throws {
        ...
        XCTAssertEqual(display.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(display.range, NSRange(location: 0, length: 5)))
        XCTAssertFalse(display.hasScript)
        XCTAssertEqual(display.index, NSNotFound)
        XCTAssertEqual(display.subDisplays.count, 3)
        ...
        XCTAssertTrue(NSEqualRanges(line1.range, NSRange(location: 2, length: 1)))
        XCTAssertFalse(line1.hasScript)
        ...
        XCTAssertTrue(NSEqualRanges(line2.range, NSRange(location: 4, length: 1)))
        XCTAssertFalse(line2.hasScript)
    }
    ...
    func testAccent() throws {
        ...
        XCTAssertTrue(NSEqualRanges(accentDisp.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(accentDisp.hasScript)
        XCTAssertTrue(CGPointEqualToPoint(accentDisp.position, CGPoint.zero))
        ...
        XCTAssertTrue(CGPointEqualToPoint(glyph.position, CGPoint(x: 11.86, y: 0)))
        XCTAssertTrue(NSEqualRanges(glyph.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(glyph.hasScript)
    ...
    func testWideAccent() throws {
        ...
        XCTAssertEqual(display2.type, .regular)
        XCTAssertTrue(CGPointEqualToPoint(display2.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(display2.range, NSRange(location: 0, length: 4)))
        XCTAssertFalse(display2.hasScript)
        XCTAssertEqual(display2.index, NSNotFound)
        XCTAssertEqual(display2.subDisplays.count, 1)
        ...
        XCTAssertTrue(CGPointEqualToPoint(line2.position, CGPoint.zero))
        XCTAssertTrue(NSEqualRanges(line2.range, NSRange(location: 0, length: 4)))
        XCTAssertFalse(line2.hasScript)

        let glyph = accentDisp.accent!
        XCTAssertTrue(CGPoint(x: 3.47, y: 0).isEqual(to: glyph.position, accuracy: 0.01))
        XCTAssertTrue(NSEqualRanges(glyph.range, NSRange(location: 0, length: 1)))
        XCTAssertFalse(glyph.hasScript)
